...
//    @Test
    ...
    public void atualizarPedidoComItens() {
        ...
        pedido.setItens(Arrays.asList(itemPedido)); // CascadeType.MERGE , se não tiver definido na classe, dará erro. Resolve ou definindo na classe ou persistindo individualmente o itemPedido.
