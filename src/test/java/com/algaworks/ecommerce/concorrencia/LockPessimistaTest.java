...
public class LockPessimistaTest {
    ...
    public void usarLockPessimistaLockModeTypePessimisticWrite() {
        ...
        Runnable runnable1 = () -> {
            ...
            //consegue pesquisar o produto, mas na hora de confirmar, um commit,
            // ela aguarda a tramsação anterior acabar e após acabar ela vai conseguir fazer o seu commit, na sequencia.
    ...
    public void usarLockPessimistaLockModeTypePessimisticRead() {
        ...
        Runnable runnable1 = () -> {
            ...
            log("Runnable 01 vai carregar o produto 1.");
            Produto produto = entityManager1.find
                    (Produto.class, 1, LockModeType.PESSIMISTIC_READ); // todas as outras transações vão poder ler as informações porém não mais commitar.
    ...
    public void usarLockNaTypedQuery() {
        ...
        Runnable runnable1 = () -> {
            ...
            log("Runnable 01 vai carregar o todos os produtos.");
