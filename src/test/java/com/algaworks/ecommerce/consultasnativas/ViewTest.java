...
public class ViewTest extends EntityManagerTest {
    ...
    public void executarView() {
        ...
        lista.stream().forEach(arr -> System.out.printf("Cliente => ID: %s, Nome: %s, Total: %s%n", arr));
    }
    ...
    public void executarViewRetornandoCliente() {
        ...
        lista.stream().forEach(obj -> System.out.printf("Cliente => ID: %s, Nome: %s", obj.getId(), obj.getNome()));
    }
}
