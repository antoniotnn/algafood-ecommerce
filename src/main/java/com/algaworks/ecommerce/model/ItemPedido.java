...
public class ItemPedido {
    ...
    @JoinColumn(name = "pedido_id", nullable = false,
            foreignKey = @ForeignKey(name = "fk_item_pedido_pedido")/*, @MapsId ja faz isso aqui: insertable = false, updatable = false*/)
    ...
    @JoinColumn(name = "produto_id", nullable = false,
            foreignKey = @ForeignKey(name = "fk_item_pedido_produto")/*, @MapsId ja faz isso aqui: insertable = false, updatable = false*/)
